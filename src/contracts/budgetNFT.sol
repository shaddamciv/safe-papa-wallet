...
/**
This contract allows the parent safe papa wallet to create superfluid NFT's
These NFT's are budget allocations for various purposes
For eg. Your child wants to pay for TUITION subscriptions, you can create an NFT with a flow rate of 10 DAI per month
The child can then transfer this NFT to the TUITION account, and the TUITION account will receive 10 DAI per month
 */
